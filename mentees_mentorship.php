...
// Fetch the mentees under the mentorship of the logged-in staff
$sql = "SELECT u.username, u.email, u.rollno, u.id as mentee_id 
        FROM staff_student_allocation ssa
        JOIN users u ON ssa.student_id = u.id
        WHERE ssa.staff_id = '$staff_id' AND ssa.role = 'mentor-mentee'";
$mentees_result = mysqli_query($conn, $sql);
$mentees = mysqli_fetch_all($mentees_result, MYSQLI_ASSOC);

// Count the number of mentees under the mentorship
...
<header>
    ...
    <div class="dashboard-container">
        ...
        <div class="mentees-mentorship">
            <h3>Mentees Under Your Mentorship</h3>
            <p><strong>Total Mentees:</strong> <?php echo $total_mentees; ?></p>
            <table>
                <thead>
                    <tr>
                        <th>Mentee Name</th>
                        <th>Mentee Email</th>
                        <th>Mentee Roll No</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($mentees as $mentee): ?>
                        <tr>
                            ...
                            <td><?php echo $mentee['email']; ?></td>
                            <td><?php echo $mentee['rollno']; ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
